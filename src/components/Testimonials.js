...
const userTestimonials = [
  {
    ...
    name: 'Affine',
    occupation: 'Alternative to Notion & Miro',
    testimonial:
  ...
  },
  {
    ...
    name: 'Plane',
    occupation: 'Alternative to JIRA',
    testimonial:
      "Plane helps you track your issues, epics, and product roadmaps in the simplest way possible. It helps manage issues, sprints, and product roadmaps with peace of min.",
  },
  {
    avatar: <Avatar alt="Travis Howard" src="/static/images/avatar/5.jpg" />,
    name: 'Twenty CRM',
    occupation: 'Alternative to Salesforce',
    testimonial:
  ...
  },
  {
    ...
    testimonial:
      "The open source Calendly successor. You are in charge of your own data, workflow, and appearance. Use it for business meetings, seminars and even calls with your families.",
  },
];
...
export default function Testimonials() {
  ...
  const handleCardClick = (index) => {
    ...
    navigate(`/productdetails?testimonialIndex=${index}`);
